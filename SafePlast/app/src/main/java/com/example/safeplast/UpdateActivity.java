    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Plasticos plasticoModel = new Plasticos(plasticos.getId(),txtNombre.getText().toString(),txtDescripcion.getText().toString(),txtUsuario.getText().toString(),txtOrigen.getText().toString(),txtUbicacion.getText().toString(),conSpinner.getSelectedItem().toString(),plasticos.getFotografia());
